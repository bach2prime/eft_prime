<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckIRItemProcess.aspx.cs"
    Inherits="EFT_Proj.Inward.CheckIRItemProcess" %>
    ...
    <asp:UpdatePanel ID="UPCheckItem" runat="server">
        <ContentTemplate>
            ...
            <asp:Button ID="Next" runat="server" Text="Next" CssClass="buttonStyle" OnClick="ProcessEdrItem" />--%>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Accept" runat="server" CssClass="buttonStyle" Text="Accept" OnClick="ProcessEdrItem"
                        Visible="false" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;--%>
