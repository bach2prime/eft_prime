<%@ Page Title="Inward: Make" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CheckItem140.aspx.cs" Inherits="EFT_Proj.Inward.CheckItem140" %>
            ...
            <div id="divEFTItemList" runat="server">
                ...
                <asp:GridView ID="gridviewTxList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <%--<input type="checkbox" runat="server" id="creditMultiChecker" style="display:<%# Convert.ToInt32(Eval("AmountCr")) > 0 ? "inline" : "none" %>" />--%>
                                <asp:CheckBox runat="server" ID="creditMultiChecker" />
                                <a href="CheckItemProcess<%# Eval("BankCode") %>.aspx?edrId=<%# Eval("EdrInId") %>&inout=edrin" target="_blank">Process</a>
