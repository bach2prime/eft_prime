<%@ Page Title="Check Inward Return" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="CheckIRItem.aspx.cs" Inherits="EFT_Proj.Inward.CheckIRItem" %>
            ...
            <div id="divEFTItemList" runat="server">
                ...
                <asp:GridView ID="gridviewTxList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a href="javascript:showCheckIRItemDetails('<%# Eval("EdrOutId") %>')">Process</a>
                            </ItemTemplate>
                        </asp:TemplateField>
