<%@ Page Title="EFT" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="About170.aspx.cs" Inherits="EFT_Proj.About170" Culture="bn-BD" UICulture="bn-BD" %>
                ...
                <td runat="server" id="Bdt1Summary" style="width: 33%;">
                    ...
                    <asp:GridView Style="margin-left: 0px; width: 100%" ID="gridviewItemsBdt" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Credit Amount" DataField="CrAmount" DataFormatString="{0:N}"></asp:BoundField>
                            <asp:BoundField HeaderText="Debit Items" DataField="DrCount"></asp:BoundField>
                            <asp:BoundField HeaderText="Debit Amount" DataField="DrAmount" DataFormatString="{0:N}"></asp:BoundField>
                        </Columns>
                ...
                <td style="width: 33%" valign="top">
                    <asp:PlaceHolder runat="server" ID="phAdminSummary">
                        ...
                        <table cellpadding="0px" cellspacing="0px" style="width: 100%;">
                            <tr>
                                <td class="RowStyleWhite" style="text-align: left">Pending DDI Batch
                                </td>
                                <td class="big RowStyleWhite">
                                    <a href="/DDI/InsertPendingDDI170.aspx">
                                        <asp:Label Text="0" ID="labelPendingDDI" runat="server" />
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td class="RowStyleWhite" style="text-align: left">Outward Batch Ready for Sending
                                </td>
                                <td class="big RowStyleWhite">
                            ...
                            <tr>
                                <td class="RowStyleWhite" style="text-align: left">Outward Return Ready for Sending
                                </td>
                                <td class="big RowStyleWhite">
                            ...
                            <tr>
                                <td class="RowStyleWhite" style="text-align: left">Inward/In Ret Parsing Error
                                </td>
                                <td class="big RowStyleWhite">
                            ...
                            <tr>
                                <td class="RowStyleWhite" style="text-align: left">User/In-Out Repair Operation
                                </td>
                                <td class="big RowStyleWhite">
                    ...
                    <asp:PlaceHolder runat="server" ID="phBranchSummary">
                        ...
                        <table cellpadding="10px" cellspacing="0px" style="width: 100%;">
                            <tr>
                                <td class="RowStyleWhite" style="text-align: left">Outward Not Sent
                                </td>
                                <td class="big RowStyleWhite">
                            ...
                            <tr>
                                <td class="RowStyleWhite" style="text-align: left">Outward Return Not Sent
                                </td>
                                <td class="big RowStyleWhite">
