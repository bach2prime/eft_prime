<%@ Page Title="EFT Outward: Data Entry" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="OutwardEftCreate.aspx.cs" Inherits="EFT_Proj.Outward.OutwardEftCreate" %>
    ...
    <fieldset class="formBoxGV">
        ...
        <table width="100%" class="dataEntryTable" cellpadding="4" cellspacing="0">
            ...
            <tr class="evenRow">
                ...
                <td colspan="2">
                    <%--Details Info of payment.--%>
                    <%--<span style="padding-left: 40px; color: red; font-weight: bold">Advice No:</span>
                                <asp:TextBox ID="tbAdviceNo" runat="server" CssClass="textBox" Width="70px"></asp:TextBox>--%>
                </td>
            </tr>
            <tr class="evenRow">
                <td colspan="4">
            ...
            <tr class="evenRow">
                <td colspan="4">
                    ...
                    <asp:GridView ID="gridviewItems" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        OnRowDeleting="gridviewItems_RowDeleting" ShowFooter="True" OnRowDataBound="gridviewItems_RowDataBound">
                        <Columns>
        ...
        <%--<cc1:ConfirmButtonExtender ID="cbe" runat="server" TargetControlID="ButtonYes"
