<%@ Page Title="EFT Outward: Data Entry" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="OutwardEftCreate140.aspx.cs" Inherits="EFT_Proj.Outward.OutwardEftCreate140" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function loadCompanyInfo() {
            var companyId = $("#tbCompanyId").val();

            if (companyId) {
                $.ajax({
                    type: "POST",
                    url: "OutwardEftCreate140.aspx/GetCompanyInfoById",
                    ...
                    success: function (response) {
                        if (response.d) {
                            ...
                            if (!$.isEmptyObject(stringyfyData))
                                $('#tbCompanyName').val(stringyfyData.CompanyName);
                            else {
                                $('#tbCompanyName').val('');
                                alert("No info found for the Company ID.");
                            }
                        }
                        else {
                            $('#tbCompanyName').val('');
                    ...
                    error: function (response) {
                        $('#tbCompanyName').val('');
                        alert("Problem in fetching Company info.");
                    }
                });
            }
            else {
        ...
        function loadSenderInfo() {
            ...
            if (accountNumber) {
                $.ajax({
                    type: "POST",
                    url: "OutwardEftCreate140.aspx/GetSenderInfoByAccNum",
                    ...
                    success: function (response) {
                        if (response.d) {
                            ...
                            if (!$.isEmptyObject(stringyfyData)) {
                                ...
                                $("#hdImageUrlTemplate").val(stringyfyData.HdSignatureImage);
                                $('#cbsImage').attr("src", stringyfyData.FirstSignatureImage);

                                console.log('stringyfyData.HdSignatureImage ::: ' + stringyfyData.HdSignatureImage + '   <<===>>   stringyfyData.FirstSignatureImage ::: ' + stringyfyData.FirstSignatureImage);
                            }
                            else {
                                $('#tbSenderName').val('');
                    ...
                    <table style="width: 100%" cellpadding="4" cellspacing="0" class="dataEntryTable">
                        <tr class="evenRow">
                            <td>
                                ...
                                <asp:CheckBox ID="CBSManualTransection" Visible="false" 
                                    runat="server" TextAlign="Right" Checked="true"
                                    Enabled="false"
                                    Text="CBS transaction manually"/>
                            </td>
                            <td>
                        ...
                        <tr class="oddRow">
                            <td>
                                ...
                                &nbsp;
                                <asp:Button runat="server" ID="FetchCompanyInfoBtn" OnClientClick="loadCompanyInfo(); return false;" Text="Fetch Company Info" class="buttonStyle" />
                            </td>
                            <td>
                ...
                <td colspan="4">
                    ...
                    <div style="padding:5px 0px; width:50%">
                        ...
                        <div>
                            ...
                            <asp:HiddenField runat="server" ID="curImgIndex" Value="1" />
            ...
            <tr class="evenRow">
                <td colspan="4">
                    ...
                    <asp:GridView ID="gridviewItems" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ForeColor="#151515" GridLines="None" Width="100%" ViewStateMode="Enabled" DataKeyNames="EdrOutId"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CBSRefNumber" HeaderText="CBS Ref No" />
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="GridItemEditBtn" runat="server" Text="Edit" CommandName="gridviewItems_RowCommand" CommandArgument='<%# Eval("EdrOutId")%>' />
                                </ItemTemplate>
                            </asp:TemplateField>
