<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CreateOutwardXml.aspx.cs" Inherits="EFT_Proj.Outward.CreateOutwardXml" %>
            ...
            <td valign="top">
                <asp:GridView ID="gvBatchList" runat="server" AutoGenerateColumns="False" CellPadding="6"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a href="/Outward/ProcessFinalizedBatch.aspx?batchId=<%# Eval("BatchOutId") %>" target="_blank">Finalize</a>
