<%@ Page Title="EFT Outward: Data Entry" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="OutwardEftCreate170.aspx.cs" Inherits="EFT_Proj.Outward.OutwardEftCreate170" %>
    ...
    <script type="text/javascript">
        ...
        function loadSenderInfo() {
            ...
            if (accountNumber) {
                $.ajax({
                    type: "POST",
                    url: "OutwardEftCreate170.aspx/GetSenderInfoByAccNum",
                ...
                <td colspan="4">
                    ...
                    <asp:GridView ID="gridviewItems" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="FtNo" HeaderText="CBS Ref No" />
