<%@ Page Title="EFT Outward: Remake" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="OutwardRemake.aspx.cs" Inherits="EFT_Proj.Outward.OutwardRemake" %>
    ...
    <fieldset id="itemList" runat="server" class="formBoxGV">
        ...
        <table style="width: 100%" cellpadding="4" cellspacing="0" class="dataEntryTable">
            <tr class="evenRow">
                ...
                <td>
                    Company Id ( <span id="SpanComID"></span>):
            ...
            <tr class="evenRow">
                <td>
                    Company Name ( <span id="SpanComName"></span>):
