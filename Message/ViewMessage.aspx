<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ViewMessage.aspx.cs" Inherits="EFT_Proj.Message.ViewMessage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>
        <b>Message From Admin</b></h3>
    <span style="font-size: 11px; color: rgb(15, 89, 141);">The page will automatically
        refresh in 25 sec.</span><br />
    <br />
    <div id="divAdminSearch" runat="server" style="float: left">
        ...
        &nbsp To : &nbsp<asp:TextBox ID="tbEndDate" runat="server" Font-Names="Trebuchet MS"
