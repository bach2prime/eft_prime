<%@ Page Title="DDI: Excel" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="DDIExcel170.aspx.cs" Inherits="EFT_Proj.Outward.DDIExcel170" %>
        ...
        <tr>
            <td style="width: 80%" valign="top">
                <fieldset class="formBoxGV">
                    ...
                    <span style="width: 120px; margin-left: 75px"><a href="../media/OneToMany_DDI_sample.xls">One-Many Sample</a> </span>
                    <span style="width: 120px; margin-left: 20px"><a href="../media/ManyToMany_DDI_sample.xls">Many-Many Sample</a> </span>
                </fieldset>
            </td>
        </tr>
        <tr>
                    ...
                    <table style="width: 100%" cellpadding="4" cellspacing="0" class="dataEntryTable">
                        ...
                        <tr class="oddRow">
                            <td>
                                Effective Entry Date
                                &nbsp;&nbsp;
                                <asp:Label CssClass="OutputDataCls" ID="tbEffectiveEntryDate" runat="server" />
                            </td>
                            <td>
                                Valid Till Date
                                &nbsp;&nbsp;
                                <asp:Label CssClass="OutputDataCls" ID="tbValidTillDate" runat="server" />
                            </td>
                        </tr>
                        ...
                        <tr class="evenRow">
                            <td>
                                Frequency
                                &nbsp;&nbsp;
                                <asp:Label CssClass="OutputDataCls" ID="tbFrequency" runat="server" />
                            </td>
                        </tr>
