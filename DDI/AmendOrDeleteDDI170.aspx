<%@ Page Title="DDI: Amend/Delete" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="AmendOrDeleteDDI170.aspx.cs" Inherits="EFT_Proj.DDI.AmendOrDeleteDDI170" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset id="freeBatches" runat="server" class="formBoxGV">
        ...
        <asp:GridView ID="gridviewOpenBatches" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                <asp:BoundField DataField="DDIBatchOutId" HeaderText="Batch ID" />
                <asp:BoundField DataField="BatchNumberOut" HeaderText="Batch No" />
                <asp:BoundField DataField="CurrencyStr" HeaderText="Currency" />
                <asp:BoundField DataField="FrequencyStr" HeaderText="Frequency" />
                ...
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        <asp:HiddenField ID="hdBatchID" runat="server" Value='<%# Eval("DDIBatchOutId") %>' />
                        <asp:LinkButton runat="server" OnClick="EditBatch_Click">Edit</asp:LinkButton>
                        &nbsp;
                        <asp:LinkButton runat="server" OnClientClick="return window.confirm('This Batch will be deleted. Are you sure?');" OnClick="DeleteBatch_Click">Delete</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
    ...
    <fieldset id="itemList" runat="server" class="formBoxGV">
        ...
        <asp:GridView ID="gridviewItems" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        <asp:HiddenField ID="hdEdrOutId" runat="server" Value='<%# Eval("DDIOutId") %>' />
                        <asp:LinkButton runat="server" OnClick="EditItem_Click">Edit</asp:LinkButton>
                        &nbsp;
                        <asp:LinkButton runat="server" OnClientClick="return window.confirm('This Item will be deleted. Are you sure?');" OnClick="DeleteItem_Click">Delete</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <FooterStyle BackColor="#F1F1F1" Font-Bold="True" ForeColor="White" />
        ...
        <fieldset id="FsRemakeForm" runat="server" class="formBoxGV">
            ...
            <table width="98%" class="dataEntryTable" cellpadding="2" cellspacing="0">
                ...
                <tr class="evenRow">
                    ...
                    <td colspan="1">
                        <asp:TextBox ID="tbRcvEmail" MaxLength="100" runat="server" CssClass="textBox"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr class="oddRow">
                    ...
                    <td colspan="1">
                        <asp:TextBox ID="tbSenderEmail" MaxLength="100" runat="server" CssClass="textBox"></asp:TextBox>
                    </td>
                </tr>
                <tr class="evenRow">
                    <td colspan="6">
        ...
        <br />
        <asp:Button ID="ButtonCloseBatch" runat="server" CssClass="buttonStyle" Text="Close"
