<%@ Page Title="DDI: Checker" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="AuthorizeDDI170.aspx.cs" Inherits="EFT_Proj.DDI.AuthorizeDDI170" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lockbt" runat="server" OnClick="LockBatchForChecker">Lock Transaction</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
